...
import 'package:paypee/views/screens/routes/cashout/confirm_cashout.dart';
      ...
      appBar: PreferredSize(
        ...
        child: Container(
            ...
            child: AppBar(
                ...
                title: RichText(
                  text: const TextSpan(text: 'Cashout', style: appbar),
                ))),
      ),
      body: SafeArea(
        child: Padding(
            ...
            children: [
              ...
              Container(
                ...
                child: Padding(
                  ...
                  child: Row(
                    children: [
                      Image.asset('assets/images/wall2.png'),
                      const SizedBox(
                        width: 7,
                      ),
                      Text(
                  ...
                  onPressed: () {
                    if (_formKey.currentState!.validate()) {
                      Navigator.of(context).push(MaterialPageRoute(
                          builder: ((context) => ConfirmCashout(amount: amount,))));
                    }
                  },
                  child: const Text(
                    'Cashout Funds',
