...
class ConfirmInvest extends StatefulWidget {
  final String amount;
  final InvestModel accept;
  const ConfirmInvest({Key? key, required this.accept, required this.amount})
      : super(key: key);

  @override
  State<ConfirmInvest> createState() => _ConfirmInvestState();
}

class _ConfirmInvestState extends State<ConfirmInvest> {
  @override
            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  const Spacer(),
                  Text(
                    widget.amount + widget.accept.percentage.toString(),
                    style: input.copyWith(fontWeight: FontWeight.w400),
                  ),
                ],
              ),
